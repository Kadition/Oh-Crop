...
public class Plant21 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if(GetComponent<SpriteRenderer>().sprite != noPlant)
        {
            ...
            if(timeD.Seconds > timeToGrowth)
            {
                ...
                if((Plot21.isWatered == 1) && (isReady == 0) && (isDead == 0))
                {
