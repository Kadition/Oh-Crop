...
public class Plant12 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if(GetComponent<SpriteRenderer>().sprite != noPlant)
        {
            ...
            if(timeD.Seconds > timeToGrowth)
            {
                ...
                if((Plot12.isWatered == 1) && (isReady == 0) && (isDead == 0))
                {
