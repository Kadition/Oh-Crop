...
public class Plant23 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if(GetComponent<SpriteRenderer>().sprite != noPlant)
        {
            ...
            if(timeD.Seconds > timeToGrowth)
            {
                ...
                if((Plot23.isWatered == 1) && (isReady == 0) && (isDead == 0))
                {
